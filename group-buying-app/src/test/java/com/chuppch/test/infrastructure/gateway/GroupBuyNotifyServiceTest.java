package com.chuppch.test.infrastructure.gateway;

import com.chuppch.infrastructure.gateway.GroupBuyNotifyService;
...
public class GroupBuyNotifyServiceTest {
    ...
    public void test_notify_api() throws Exception {
        ...
        String notifyRequestDTOJSON2 = "{\"teamId\":\"57198893\",\"outTradeNoList\":[\"038426231487\",\"652896391719\",\"619401409195\"]}";
